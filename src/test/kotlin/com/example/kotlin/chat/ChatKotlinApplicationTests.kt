...
//
//	@Autowired
//	lateinit var messageRepository: MessageRespository
//
...
//
//	@Test
//	fun `test that messages API returns latest messages with last message`() {
...
////			.apply {
////				assertThat(this.copy(id = "testIdnew", sent = sent.truncatedTo(MILLIS)))
////					.isEqualTo(Message(
////						"`HelloWorld`",
////						ContentType.PLAIN,
